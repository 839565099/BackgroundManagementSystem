...
<link rel="stylesheet"
	...
	<script type="text/javascript">
		...
		//动态改变下拉框
        function  X() {
			$("#pageSize option[value=${pageInfo.pageSize}]").attr("selected", "selected");
		}

		//手动分页
		function gotoPage(currPage) {
			//同时获取每页多少条 且让它一改变就显示第一页
			var pageSize = $("#pageSize").val();
			if (currPage>0&&currPage<=${pageInfo.pages})
			window.location.href="${pageContext.request.contextPath}/product/findAll?currPage="+currPage+"&pageSize="+pageSize;
		}
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<%--整个表 包括复选框加入表单中 方便提交表单就获取需要删除的id--%>
                       <form id="delform" action="${pageContext.request.contextPath}/product/delMany">
						...
						<table id="dataList"
							...
							<tbody>
							<c:forEach items="${pageInfo.list}" var="product" varStatus="i"><!--varStatus:为了下面id顺序显示-->
								<tr>
									...
									<td class="text-center">
										...
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/product/updateById?id=${product.id}"'>修改</button>
									</td>
								</tr>
							</c:forEach>
							</tbody>
