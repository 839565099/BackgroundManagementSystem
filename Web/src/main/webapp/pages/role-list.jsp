	...
	<script type="text/javascript">
		function gotopage(currpage) {
			...
			if (currpage>0&&currpage<=${pageInfo.pages}){
				location.href="${pageContext.request.contextPath}/role/findAll?currPage="+currpage+"&pageSize="+pageSize
			}
		}
		//动态改变下拉框
		function  X() {
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="role" varStatus="i">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/addpermissionToRole?roleId=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control" onchange="gotopage(1)" id="sel">
