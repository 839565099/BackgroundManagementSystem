...
<link rel="stylesheet"
	...
	<script>
		...
		function gotopage(currpage) {
			...
			if (currpage>0&&currpage<=${pageInfo.pages}){
				location.href="${pageContext.request.contextPath}/user/findAll?currPage="+currpage+"&pageSize="+pageSize;
			}
		}
		//动态改变下拉框
		function  X() {
			$("#sel option[value=${pageInfo.pageSize}]").attr("selected", "selected");
		}
	</script>
</head>

<body class="hold-transition skin-blue sidebar-mini" onload="X()">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form action="${pageContext.request.contextPath}/user/delMany" id="d1">
							<!--数据列表-->
							<table id="dataList"
									...
									<c:forEach items="${pageInfo.list}" var="user" varStatus="i">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/detils?uid=${user.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/addRoleToUserUI?uid=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}/user/delOne?id=${user.id}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control" id="sel" onchange="gotopage(1)">
